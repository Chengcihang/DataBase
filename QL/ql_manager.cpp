...
RC QL_Manager::SetUpNodes(QL_Node *&topNode, int nSelAttrs, const RelAttr selAttrs[]){
    ...
    // For all other relations, join it, left-deep style, with the previously seen relations
    // 连接其他关系表
    QL_Node* currNode;
    currNode = topNode;
...
RC QL_Manager::RunDelete(QL_Node *topNode){
    ...
    // Open the appropriate file, and Attr* list for holding IX_IndexHandles for efficient index updates
